        ...
        foreach ($produits as $produit) {
          ...
          <form action="" method="POST">
            ...
            <tr>
              ...
              <td>
                <?= $produit['prixEnchere'] == '00.00' || $produit['prixEnchere'] == '' ? 'N/A' : $produit['prixEnchere'] . '€'; ?>
              </td>
              ...
              <td><input class="submit" name="modifierLot" type="submit" value="Modifier"></td>
              <td><input class="submit" name="supprimerLot" type="submit" value="Supprimer"></td>
            </tr>
          </form>
          <?php
